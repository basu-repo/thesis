...
This module is the standalone deep-learning workflow for the thesis.

It is the active training and comparison stack for the current repository
layout. All data preparation, model definition, training, evaluation, and
result saving for learned trajectory prediction should live here.
